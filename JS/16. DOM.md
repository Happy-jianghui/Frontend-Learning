...
### 5.3.2 子节点
![image](https://github.com/Happy-jianghui/Frontend-Learning/assets/98568967/ecee2266-6249-483a-8534-7423b21bdf6d)
parentNode.childNodes 返回包含指定节点的子节点的集合，该集合即时更新的集合。  
...
## 5.4 创建节点
![image](https://github.com/Happy-jianghui/Frontend-Learning/assets/98568967/a8bbfce9-418a-49f8-96c9-2b98c9c53972)
document.createElement()方法创建由tagName指定的HTML元素。因为这些元素原先不存在，是根据我们的需求动态生成的，所以我们也称为**动态创建元素节点**。  

### 5.4.1 添加节点
![image](https://github.com/Happy-jianghui/Frontend-Learning/assets/98568967/04bcdc7e-bb2f-4d05-a283-ddc4230b2a19)
node.appendChild() 方法将一个节点添加到指定父节点的子节点列表**末尾**。类似于css里面的after伪元素。  

![image](https://github.com/Happy-jianghui/Frontend-Learning/assets/98568967/4f2a456e-38a0-4249-b4a6-3a61ea1ed3bd)
node.insertBefore() 方法将要给节点添加到父节点的指定子节点**前面**。类似于css里面的before伪元素。  

## 5.5 删除节点
![image](https://github.com/Happy-jianghui/Frontend-Learning/assets/98568967/cebeeec2-9970-4ce2-8d5e-cc10de4f9943)
node.removeChild() 方法从DOM 中删除一个子节点，返回删除的节点。  

## 5.6 复制节点（克隆节点）
![image](https://github.com/Happy-jianghui/Frontend-Learning/assets/98568967/8edbca5d-eabc-47d7-81a9-c43debd49d7d)
node.cloneNode() 方法返回调用该方法的节点的一个副本。也成为克隆节点、拷贝节点。  
**注意：**
 1. 如果括号参数为**空或者false**，则是**浅拷贝**，即只克隆复制节点本身，不可能里面的子节点（内容）。
 1. 如果括号参数为**true**，则是**深拷贝**，会复制节点本身以及里面所有的子节点（内容）。
