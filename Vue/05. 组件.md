...
作用：提供数据的双向绑定  
<img width="668" alt="image" src="https://github.com/user-attachments/assets/bcbc5516-852d-4a5d-90a7-4ba333390b92">
```Vue
<template>
    <div id="app">
...
```
2. 恰当时机，通过this.$ref.XXX，获取目标组件，就可以调用组件对象里面的方法
```JavaScript
